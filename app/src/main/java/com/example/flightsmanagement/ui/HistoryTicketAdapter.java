...
public class HistoryTicketAdapter extends RecyclerView.Adapter<HistoryTicketAdapter.TicketViewHolder> {
    private final List<Ticket> ticketList;

    public HistoryTicketAdapter(List<Ticket> ticketList) {
    ...
    public TicketViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.ticket_history_item, parent, false);
    ...
    public void onBindViewHolder(@NonNull TicketViewHolder holder, int position) {
        ...
        holder.customerNameTextView.setText("Customer: " + ticket.getName() + "\n");
        holder.customerNameTextView.setTextSize(24);
